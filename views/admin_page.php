...
if (empty($_SESSION) or $_SESSION["privillege"] !=1){
    ...
    // header("Location: can_not_access.php" );
    exit;
 }
    ...
    <div>
        <div class="container-fluid d-block d-md-flex " id="header">
            ...
            <div id="user" class="text-center"  >
                Wellcome <strong> <?php echo  $_SESSION["name"] ?></strong>, <a href="logout.php">logout</a>
            </div>
            ...
            <div id="content">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="./admin_user.php"><i class="bi bi-arrow-right"></i>
                                    More details</a></td>
                ...
                <div class="mb-4" id="web-models">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <th><a href="./admin_question.php">Questions</a></th>
                                <td><a href="./admin_question.php"><i class="bi bi-arrow-right"></i>
                                    More details</a></td>
                                
                            </tr>
                            <tr>
                                <th><a href="./admin_topic.php">Topic</a></th>
                                <td><a href="./admin_topic.php"><i class="bi bi-arrow-right"></i>
                                    More details</a></td>
