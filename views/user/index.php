        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 px-5">
              ...
              <li class="nav-item me-5">
                <a class="nav-link active" aria-current="page" href="#"><i class="bi bi-door-open"></i>
Login</a>
              </li>
              <li class="nav-item me-5">
                <a class="nav-link active" aria-current="page" href="#"><i class="bi bi-clock-history"></i>
Test history</a>
              </li>
            </ul>
      ...
      <div id="" class="col-md-6 col-lg-5 pb-3">
        ...
        If you don't know your level, you can start by taking a Level Test.</p>
        ...
        <div class="row row-cols-1 row-cols-md-3 g-4">
          <div class="col">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <p class="card-text">This will contain all the test with begineer level for you to try </p>
                <button type="button" class="btn btn-outline-success">
                  See more</i>
                </button>
              </div>
          ...
          <div class="col">
            <div class="card">
              <img src="../../images/inter3.jpeg" class="card-img-top" alt="..." style="width: 300px; height: 300px;">
              <div class="card-body">
